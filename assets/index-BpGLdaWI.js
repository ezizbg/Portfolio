...
const l = document.querySelector(".header__burger"),
  f = document.querySelector(".header__top-menu");
l &&
  l.addEventListener("click", function (s) {
    l.classList.toggle("_x"),
      f.classList.toggle("_x"),
...
if (d.length > 0) {
  let s = function (o) {
    ...
    if (i.dataset.goto && document.querySelector(i.dataset.goto)) {
      const t =
        document.querySelector(i.dataset.goto).getBoundingClientRect().top +
        window.pageYOffset -
        30;
      l.classList.contains("_x") &&
        (l.classList.remove("_x"),
        f.classList.remove("_x"),
...
window.scrollTo = function (s) {
  if ((s == null ? void 0 : s.behavior) === "smooth") {
    ...
    const t = (r) => {
      e = e || r;
      const c = Math.min((r - e) / n, 1);
      u(0, o + i * c), c < 1 && requestAnimationFrame(t);
    };
...
if (a.length > 0) {
  let s = function () {
    ...
    o = function (i) {
      ...
      return { top: n.top + t, left: n.left + e };
    };
  var g = s,
    p = o;
