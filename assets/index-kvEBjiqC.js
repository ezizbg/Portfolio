...
window.scrollTo = function (n) {
  if ((n == null ? void 0 : n.behavior) === "smooth") {
    ...
    const o = (r) => {
      ...
      u(0, t + s * c), c < 1 && requestAnimationFrame(o);
    };
...
document.addEventListener("DOMContentLoaded", function () {
  const n = document.querySelectorAll(".works__card"),
  ...
  let n = function () {
      for (let s = 0; s < l.length; s++) {
        ...
        e > window.innerHeight &&
          ...
          pageYOffset > o - c && pageYOffset < o + e
...
document.addEventListener("DOMContentLoaded", function () {
  setTimeout(function () {
    const n = document.querySelector(".name-animation"),
      t = document.querySelector(".job-animation");
    n &&
      t &&
      ((n.style.animation = "none"),
      (t.style.animation = "none"),
      setTimeout(function () {
        (n.style.animation = ""), (t.style.animation = "");
      }, 50));
  }, 300);
});
